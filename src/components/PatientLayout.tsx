...
import { Heart, Search, Calendar, Clock, LogOut, Menu, X, MapPin, History } from 'lucide-react';
...
const navItems = [
  ...
  { to: '/visit-history', label: 'History', icon: History },
];
      ...
      <header className="sticky top-0 z-50 border-b bg-card/80 backdrop-blur-sm">
        <div className="mx-auto flex h-16 max-w-6xl items-center justify-between px-4">
          <Link to="/" className="flex items-center gap-2 font-bold text-lg">
            ...
            <span className="hidden sm:inline" style={{ fontFamily: 'Space Grotesk, sans-serif' }}>MedQueue</span>
          </Link>
